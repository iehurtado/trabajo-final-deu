...
export class AppService {
    ...
    getHello(observe?: 'body', options?: RequestOptions<'json'>): Observable<any>;
    getHello(observe?: 'response', options?: RequestOptions<'json'>): Observable<HttpResponse<any>>;
    getHello(observe?: 'events', options?: RequestOptions<'json'>): Observable<HttpEvent<any>>;
    getHello(observe?: 'body' | 'events' | 'response', options?: RequestOptions<'arraybuffer' | 'blob' | 'json' | 'text'>): Observable<any> {
